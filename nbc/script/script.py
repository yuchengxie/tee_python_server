  ...
  def _process(self, script):  # parse the script into tokens
    ...
    while script:
      ...
      if opcode == opcodes.OP_0:
        ...
        if len(value) != length:
          print('bak_script',opcode,len(value),length,bak_script)
